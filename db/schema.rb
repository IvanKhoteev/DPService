...
ActiveRecord::Schema.define(version: 20151005185640) do
  ...
  create_table "trade_objects", force: :cascade do |t|
    ...
    t.decimal  "average_actual_current_price", precision: 15, scale: 2, default: 0.0
    t.decimal  "amount_of_sales",              precision: 15, scale: 2, default: 0.0
  end
